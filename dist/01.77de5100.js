...
var boxMove = document.querySelector('.box');
var mouseMove = rxjs_1.fromEvent(document, "mousemove");
var mouseUp = rxjs_1.fromEvent(document, "mouseup");
var mouseDown = rxjs_1.fromEvent(boxMove, "mousedown");
mouseDown.pipe(operators_1.map(function (e) {
  ...
  var offsetX = _a.offsetX,
      offsetY = _a.offsetY;
  return mouseMove.pipe(operators_1.takeUntil(mouseUp), operators_1.map(function (moveEvent) {
    return {
      x: moveEvent.clientX - offsetX,
      y: moveEvent.clientY - offsetY
    };
  }));
}), operators_1.concatAll()).subscribe(function (_a) {
  var x = _a.x,
      y = _a.y;
  boxMove.style.transform = "translate(" + x + "px, " + y + "px)";
});
},{"rxjs":"../../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../../node_modules/rxjs/_esm5/operators/index.js"}],"../../../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../.nvm/versions/node/v8.11.3/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.ts"], null)
